...
public class PersonsHistoryListRender  extends JPanel implements ListCellRenderer<Log_Person>{

    @Override
    public Component getListCellRendererComponent(JList<? extends Log_Person> list, Log_Person value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        switch (rol_type) {
            case "ADD":
                description = "ha creado la persona";
                break;
            case "EDIT":
                description = "ha editado la persona";
                break;
            case "DELETE":
                description = "ha eliminado la persona";
                break;
            default:
                break;
        }
        ...
        // Mostrar Persona cambiada
        String rol = value.getId_persona();
