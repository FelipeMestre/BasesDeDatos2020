...
import model.Log_functionality;

import javax.swing.*;
import java.awt.*;

public class FunctionalityHistoryListRender extends JPanel implements ListCellRenderer<Log_functionality>{

    @Override
    public Component getListCellRendererComponent(JList<? extends Log_functionality> list, Log_functionality value, int index, boolean isSelected, boolean cellHasFocus) {
        ...
        switch (funct_type) {
            case "ADD":
                description = "ha creado la funcionalidad";
                break;
            case "EDIT":
                description = "ha editado el funcionalidad";
                break;
            case "DELETE":
                description = "ha eliminado el funcionalidad";
                break;
            default:
                break;
        }
        ...
        // Mostrar Rol
        String functionality = value.getFunc_name();
        JLabel func_name = new JLabel(functionality);
        func_name.setForeground(new Color(102,102,102));
        font = new Font("Segoe UI", Font.BOLD, 11);
        func_name.setFont(font);
                        ...
                        .addGroup(panel1Layout.createSequentialGroup()
                                ...
                                .addGroup(panel1Layout.createParallelGroup()
                                        ...
                                        .addGroup(panel1Layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(func_name, 90, 90, 90)
                                        ))
                                .addContainerGap())
        );
                ...
                panel1Layout.createParallelGroup()
                        .addGroup(panel1Layout.createSequentialGroup()
                                ...
                                .addGroup(panel1Layout.createParallelGroup()
                                        .addComponent(user_name, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(func_description, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                        .addComponent(func_name, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
