/*
 * Created by JFormDesigner on Sat Nov 07 16:01:06 UYT 2020
 */
 ...
 * @author unknown
 */
public class EditMenuForm extends JFrame {
    private ModelConstructor constructor;
    private MainMenu parent;
    private String menu_id;

    public EditMenuForm(MainMenu parent, ModelConstructor controller, String menu_id, String menu_name, String menu_desc) {
        this.constructor = controller;
        this.parent = parent;
        this.menu_id = menu_id;
        initComponents();
        this.Nombre.setText(menu_name);
        this.Descripcion.setText(menu_desc);
    }
    ...
    private void SubmitActionPerformed() {
        ...
        if (!newName.equals("") && !newDesc.equals("")){
            constructor.updateRole(menu_id, newName, newDesc);
            parent.fetchRoles();
            exitForm();
        }
    }
    ...
    private void initComponents() {
        ...
        //======== panel1 ========
        {
            ...
            //---- NameTitle ----
            NameTitle.setText("Nombre del menu");
