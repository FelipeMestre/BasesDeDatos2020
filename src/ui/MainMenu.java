...
public class MainMenu extends JFrame {
    ...
    private void updateUserRolesTable(Role[][] newData, AddRoleUserRequest[][] newAuthorizations) {
        ...
        userRolesHistory.setListData(controller.getUserRoleLog());
        userRolesHistory.setCellRenderer(new UserRoleHistoryListRender());
    ...
    private void updateFuncionalityRoleTable(Role[][] newData) {
        ...
        scrollPane3.setBorder(new LineBorder(new Color(0, 0, 0, 0)));
    ...
    private void initComponents() {
        ...
        //======== main ========
        {
            ...
            //======== Permisos ========
            {
                ...
                RelacionesTitle2.setFont(new Font("Segoe UI", Font.BOLD, 32));
                ...
                RelacionesDescription2.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 12));
                ...
                //======== layeredPane14 ========
                {
                    ...
                    scrollTable7.setBounds(30, 55, 160, 145);
                    ...
                    rolesToUsersPane.setBounds(205, 55, 300, 145);

                    //======== scrollHistoryUser2 ========
                    {
                        scrollHistoryUser2.setBorder(null);

                        //---- userRolesHistory ----
                        userRolesHistory.setBackground(Color.white);
                        userRolesHistory.setBorder(null);
                        userRolesHistory.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
                        userRolesHistory.setVisibleRowCount(10);
                        scrollHistoryUser2.setViewportView(userRolesHistory);
                    }
                    layeredPane14.add(scrollHistoryUser2, JLayeredPane.DEFAULT_LAYER);
                    scrollHistoryUser2.setBounds(520, 55, 220, 145);
                    ...
                    addUsersRoles_back.setBounds(0, 10, 780, 215);
                }
                ...
                //======== layeredPane12 ========
                {
                    ...
                    scrollPane2.setBounds(30, 35, 255, 110);
                    ...
                    scrollPane3.setBounds(300, 35, 440, 110);
